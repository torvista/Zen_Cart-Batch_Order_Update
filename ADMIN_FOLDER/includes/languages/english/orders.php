...
define('SUCCESS_ORDER_UPDATED', 'Success: order %s has been updated.'); // plugin Batch Order Update
define('WARNING_ORDER_NOT_UPDATED', 'Warning: Nothing to change. Order %s was not updated.'); // plugin Batch Order Update
...
define('SUCCESS_EMAIL_SENT', 'Email %1$s sent for order %2$s'); // plugin Batch Order Update
//bof plugin Batch Order Update
define('TEXT_BATCH_UPDATE', 'Batch Update');
define('HEADING_TITLE_BATCH_UPDATE', 'Batch Update');
define('TEXT_BATCH_STATUS_UPDATE', 'Update Order Statuses');
define('TEXT_SELECT_NEW_STATUS', 'Select new Order Status');
define('TEXT_BATCH_SELECT_ALL', 'Select All');
define('TEXT_BATCH_NO_CHECKBOX_SELECTED', 'Error: no order checkbox selected');
define('TEXT_BATCH_NO_STATUS_SELECTED', 'Error: no new Order Status selected');
//eof